...
export default function LoginPage() {
  ...
  return (
    <section className="lg mx-auto">
      ...
      {useri?.uid ? <></> : <button className="absolute bottom-10 v right-0 left-0 border-0 rounded-xl px-3 py-4 block w-4/5 bg-amber-400 mx-auto" onClick={signInWithKakao}>카카오 로그인 </button>}
